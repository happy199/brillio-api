...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Default empty data for Free plan
        $personalityStats = [];
        $activityLabels = [];
        $activityData = ['signups' => [], 'tests' => [], 'sessions' => []];
        $cityStats = [];
        $ageStats = ['18-24' => 0, '25-30' => 0, '30+' => 0];
        $documentStats = [];

        // Old chart data (Registration Trend) - Available for everyone or limited? 
        // Let's keep registration trend for everyone as a teaser.
