...
class SecurityHeadersMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp .= "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://code.jquery.com https://www.googletagmanager.com https://www.google-analytics.com; ";
