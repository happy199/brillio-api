...
<div class="space-y-6 text-center">
    ...
    <div class="bg-gray-50 border border-gray-200 rounded-2xl p-5 text-center space-y-3">
        ...
        <label for="verification_code" class="text-xs text-gray-500 block">
        ...
        <form method="POST" action="{{ route('verification.verify-code') }}" class="space-y-3">
            @csrf
            <div class="flex justify-center">
                <input id="verification_code" type="text" name="code" maxlength="6" pattern="[0-9]{6}" placeholder="123456" required
