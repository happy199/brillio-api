...
@section('subheading', 'Partagez votre expérience et inspirez la jeunesse africaine')
        ...
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-semibold text-red-800">
                    ⚠️ Ce lien d'invitation est expiré
                </h3>
                <p class="mt-1 text-sm text-red-700">
                    Vous pouvez continuer la connexion/inscription, mais vous ne serez pas lié directement à
                    l'organisation partenaire. Veuillez demander un nouveau lien valide pour acter de la liaison.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-700 mt-1">
                    Pour garantir la qualité de notre communauté de mentors, nous utilisons LinkedIn pour vérifier votre
                    identité professionnelle et récupérer votre photo de profil.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="pt-4 border-t border-gray-100">
        ...
        <ul class="space-y-2">
            <li class="flex items-center gap-2 text-sm text-gray-600">
                ...
                Créer votre profil professionnel inspirant
            </li>
            <li class="flex items-center gap-2 text-sm text-gray-600">
                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                Partager votre parcours étape par étape
            </li>
            <li class="flex items-center gap-2 text-sm text-gray-600">
                <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
            ...
            <li class="flex items-center gap-2 text-sm text-gray-600">
                ...
                Rejoindre une communauté de professionnels engagés
            </li>
        </ul>
    </div>
</div>
