...
<div class="space-y-6">
        ...
        <div class="flex items-start">
            ...
            <div class="ml-3">
                ...
                <p class="mt-1 text-sm text-red-700">
                    Vous pouvez continuer l'inscription, mais vous ne serez pas lié directement à l'organisation
                    partenaire. Veuillez demander un nouveau lien valide pour acter de la liaison.
                </p>
            </div>
        </div>
    </div>
    ...
    @if(isset($organizationName) && $organizationName && (!isset($isExpired) || !$isExpired))
    <!-- Organization Sponsorship Banner -->
        ...
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-semibold text-green-800">
                    🎉 Vous êtes parrainé par {{ $organizationName }} !
                </h3>
                <p class="mt-1 text-sm text-green-700">
                    En créant votre compte, vous serez automatiquement lié à cette organisation partenaire.
                </p>
            </div>
        </div>
    </div>
