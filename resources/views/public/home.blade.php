...
@section('content')
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white" data-aos="fade-right">
                    ...
                    <p class="text-xl text-white/90 mb-8 max-w-lg">
                        Découvre ta personnalité, explore les métiers qui te correspondent et connecte avec des mentors africains qui ont réussi.
                    </p>
                    ...
                    <div class="relative mx-auto w-72 sm:w-80">
                        ...
                        <div class="relative bg-gray-900 rounded-[3rem] p-3 shadow-2xl float-animation">
                            <div class="bg-gray-800 rounded-[2.5rem] overflow-hidden">
                                ...
                                <div class="aspect-[9/19] bg-gradient-to-b from-primary-100 to-secondary-100 flex items-center justify-center">
                                    <div class="text-center p-6">
                                        <div class="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-2xl flex items-center justify-center">
                            ...
                            <!-- Notch -->
                            <div class="absolute top-3 left-1/2 transform -translate-x-1/2 w-24 h-6 bg-gray-900 rounded-full"></div>
                        </div>
                        <!-- Decorative elements -->
                        <div class="absolute -top-8 -right-8 w-24 h-24 bg-accent-400 rounded-2xl rotate-12 opacity-80"></div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60">
                ...
                <div class="h-12 w-32 bg-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">Partenaire 1</div>
                <div class="h-12 w-32 bg-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">Partenaire 2</div>
                <div class="h-12 w-32 bg-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">Partenaire 3</div>
                <div class="h-12 w-32 bg-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">Partenaire 4</div>
                <div class="h-12 w-32 bg-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">Partenaire 5</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Solution -->
            <div class="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-3xl p-8 md:p-12 text-white" data-aos="fade-up">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        <span class="inline-block px-4 py-2 bg-white/20 rounded-full text-sm font-medium mb-4">La solution</span>
                        ...
                        <a href="#fonctionnalites" class="inline-flex items-center text-white font-semibold hover:underline">
    ...
    <section id="fonctionnalites" class="py-20 bg-gray-50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-14 h-14 bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Feature 3: Mentoring -->
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="300">
                ...
                <!-- Feature 4: Documents -->
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="400">
                ...
                <!-- Feature 5: Profil -->
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="500">
                ...
                <!-- Feature 6: Gratuit -->
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="600">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    <div class="relative inline-block mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-full flex items-center justify-center text-white text-3xl font-bold">
                            1
                        </div>
                        <div class="hidden md:block absolute top-1/2 left-full w-full h-0.5 bg-gradient-to-r from-primary-500 to-transparent"></div>
                    </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    <div class="relative inline-block mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-secondary-500 to-accent-500 rounded-full flex items-center justify-center text-white text-3xl font-bold">
                            2
                        </div>
                        <div class="hidden md:block absolute top-1/2 left-full w-full h-0.5 bg-gradient-to-r from-secondary-500 to-transparent"></div>
                    </div>
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    <div class="relative inline-block mb-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-accent-500 to-primary-500 rounded-full flex items-center justify-center text-white text-3xl font-bold">
                            3
                        </div>
                    </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        ...
                        "Grâce à Brillio, j'ai découvert que j'étais ENFJ et que les métiers du marketing me correspondaient parfaitement. Aujourd'hui je suis en stage dans une agence !"
                    </p>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        <!-- TODO: Ajouter vrai témoignage -->
                        "Le chatbot IA est incroyable ! Il m'a donné des conseils super adaptés à la situation au Cameroun. Je le recommande à tous mes amis."
                    </p>
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center text-gray-500">
                            <!-- TODO: Ajouter photo -->
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-gray-600 mb-6 italic">
                        <!-- TODO: Ajouter vrai témoignage -->
                        "Les profils de mentors m'ont vraiment inspiré. Voir des parcours de professionnels africains qui ont réussi, ça change tout !"
                    </p>
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center text-gray-500">
                            <!-- TODO: Ajouter photo -->
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center text-white">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 mb-12" data-aos="fade-up" data-aos-delay="200">
                    <!-- App Store -->
                    <a href="#" class="flex items-center justify-center space-x-3 bg-black text-white rounded-xl px-8 py-4 hover:bg-gray-900 transition-colors">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center" data-aos="fade-up">
                ...
                <form class="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                    ...
                    <button type="submit" class="px-8 py-3 bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300">
                        S'inscrire
                    </button>
                </form>
                <p class="text-xs text-gray-500 mt-4">
                    En t'inscrivant, tu acceptes notre <a href="{{ route('privacy') }}" class="underline">politique de confidentialité</a>.
                </p>
            </div>
        </div>
    </section>
