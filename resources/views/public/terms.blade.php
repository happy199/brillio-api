...
@section('title', 'Conditions d\'utilisation - Brillio')
@section('meta_description', 'Conditions générales d\'utilisation de l\'application Brillio. Lisez nos termes et conditions avant d\'utiliser nos services.')
