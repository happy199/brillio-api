...
<div class="min-h-screen bg-gray-50 pt-24 pb-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
            class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 shadow-sm border border-purple-100 mb-8 relative overflow-hidden">
            <div
                class="absolute top-0 right-0 w-64 h-64 bg-white/40 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none">
            </div>

            <div class="relative flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
                <div class="flex-shrink-0">
                    <div
                        class="w-20 h-20 bg-white rounded-2xl flex items-center justify-center text-purple-600 shadow-sm">
            ...
            <div class="md:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    ...
                    <a href="{{ $profile->portfolio_url }}" target="_blank"
                        ...
                        <span class="text-gray-700 font-medium group-hover:text-indigo-600 truncate">{{
