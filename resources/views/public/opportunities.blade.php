...
@section('title', isset($isScoreView) ? 'Mon score Career - Analyse détaillée' : 'Opportunités & Mon CV - Analyse IA')

@section('content')
<div class="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50 pt-28 pb-20" x-data="cvUploaderApp({{ isset($isScoreView) && $isScoreView ? 'true' : 'false' }}, {{ isset($cvAnalysis) ? json_encode($cvAnalysis) : 'null' }})">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center text-sm font-medium text-gray-500 mb-6 space-x-2">
            ...
            <span>/</span>
            <span class="text-gray-900 font-semibold" x-text="isScoreView ? 'Mon score Career' : 'Mon CV'">Mon CV</span>
        </nav>

        <!-- Vue 1 & 2 : Import et Aperçu du CV (Non soumis ou en cours) -->
        <div x-show="!isScoreView" x-cloak>
            <!-- Header -->
            <div class="mb-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5 space-y-6">
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div x-show="selectedFile" x-cloak class="space-y-4">
                ...
                <div class="lg:col-span-7">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 min-h-[500px] flex flex-col">
                        ...
                        <div x-show="selectedFile" x-cloak class="flex-1 space-y-6">
        ...
        <div x-show="isScoreView" x-cloak>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                ...
                <div class="self-start sm:self-auto">
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 text-emerald-800 font-bold text-sm">
                        ...
                        Score global <span x-text="analysisData?.global_score || 66"></span>/100
                    </span>
                </div>
            </div>
                    ...
                    <div class="relative w-44 h-44 flex-shrink-0 flex items-center justify-center">
                        <svg class="w-full h-full transform -rotate-90" viewBox="0 0 120 120">
                            ...
                            <circle cx="60" cy="60" r="50" fill="none" stroke="#10B981" stroke-width="10"
                                    ...
                                    :stroke-dashoffset="314.159 - (314.159 * (analysisData?.global_score || 66) / 100)"
                                    class="transition-all duration-1000 ease-out" />
                        </svg>
                        <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                            <span class="text-4xl font-extrabold text-gray-900" x-text="analysisData?.global_score || 66">66</span>
                    ...
                    <div class="flex-1 text-center md:text-left space-y-3">
                        <div class="flex items-center justify-center md:justify-start gap-3 flex-wrap">
                            ...
                            <span class="px-3 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800"
                                  x-text="analysisData?.status_label || 'Très bien'">Très bien</span>
                        </div>
                        <p class="text-lg font-bold text-gray-800 uppercase tracking-wide" x-text="analysisData?.candidate_name || 'FATOUMATA TRAORÉ'"></p>
            ...
            <div class="bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-100/50 border-2 border-emerald-200/80 rounded-3xl p-8 sm:p-10 shadow-sm relative overflow-hidden">
                <div class="max-w-3xl space-y-4">
                    ...
                    <div class="pt-4 flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <button type="button" @click="resetToUpload()" class="w-full sm:w-auto px-6 py-4 rounded-xl bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-semibold text-sm transition text-center">
                            Tester un autre CV
                        </button>
                    </div>
...
<script>
function cvUploaderApp(initialIsScore, initialData) {
    return {
        isScoreView: initialIsScore,
        ...
        setFile(file) {
            ...
            // Heuristique pour extraire un nom à partir du nom de fichier (ex: CV_Fatoumata_Traore_UXUI.docx)
            let rawName = file.name.replace(/\.[^/.]+$/, ""); // sans extension
        ...
        async submitCv() {
            ...
            try {
                ...
                // Fallback soumission formulaire classique si fetch échoue
        ...
        resetToUpload() {
            ...
            window.history.pushState({}, '', '{{ route('public.opportunities') }}');
        }
    };
}
</script>
