                ...
                <div data-aos="fade-right">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4 p-6 bg-gray-50 rounded-2xl">
                            ...
                            <div>
                                ...
                                <a href="mailto:contact@brillio.africa" class="text-primary-600 hover:underline font-medium">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center hover:bg-primary-100 hover:text-primary-600 transition-colors">
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="subject" name="subject" required
                                    ...
                                    <option value="Devenir mentor" {{ old('subject') == 'Devenir mentor' ? 'selected' : '' }}>Devenir mentor</option>
                                    <option value="Partenariat" {{ old('subject') == 'Partenariat' ? 'selected' : '' }}>Partenariat</option>
                                    <option value="Presse / Média" {{ old('subject') == 'Presse / Média' ? 'selected' : '' }}>Presse / Média</option>
                            ...
                            <p class="text-xs text-gray-500 text-center">
                                ...
                                <a href="{{ route('privacy') }}" class="underline">politique de confidentialité</a>.
                            </p>
                        </form>
                    </div>
                </div>
                ...
                <div class="space-y-4" x-data="{ open: null }">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                        <button @click="open = open === 1 ? null : 1"
                            ...
                            <svg class="w-5 h-5 text-gray-500 transition-transform duration-200" :class="{ 'rotate-180': open === 1 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="open === 1" x-collapse class="px-6 pb-4">
                            <p class="text-gray-600">
                                ...
                                Brillio est disponible gratuitement sur l'App Store pour iOS et le Google Play Store pour Android.
                                Recherchez simplement "Brillio" ou suivez les liens de téléchargement sur notre page d'accueil.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="150">
                        <button @click="open = open === 2 ? null : 2"
                            ...
                            <svg class="w-5 h-5 text-gray-500 transition-transform duration-200" :class="{ 'rotate-180': open === 2 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div x-show="open === 2" x-collapse class="px-6 pb-4">
                            <p class="text-gray-600">
                                Oui, Brillio est 100% gratuite. Toutes les fonctionnalités (test de personnalité, chatbot IA,
                                accès aux profils de mentors, gestion de documents) sont accessibles sans frais et sans abonnement.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                        <button @click="open = open === 3 ? null : 3"
                            ...
                            <svg class="w-5 h-5 text-gray-500 transition-transform duration-200" :class="{ 'rotate-180': open === 3 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div x-show="open === 3" x-collapse class="px-6 pb-4">
                            <p class="text-gray-600">
                                ...
                                Si vous êtes un professionnel africain souhaitant partager votre parcours et inspirer les jeunes,
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="250">
                        <button @click="open = open === 4 ? null : 4"
                            ...
                            <svg class="w-5 h-5 text-gray-500 transition-transform duration-200" :class="{ 'rotate-180': open === 4 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div x-show="open === 4" x-collapse class="px-6 pb-4">
                            <p class="text-gray-600">
                                ...
                                <a href="{{ route('privacy') }}" class="text-primary-600 hover:underline">politique de confidentialité</a>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                        <button @click="open = open === 5 ? null : 5"
                            ...
                            <svg class="w-5 h-5 text-gray-500 transition-transform duration-200" :class="{ 'rotate-180': open === 5 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div x-show="open === 5" x-collapse class="px-6 pb-4">
                            <p class="text-gray-600">
                                ...
                                sur l'orientation, les métiers et les formations. Il est spécialement entraîné pour comprendre
                                le contexte africain et donner des conseils pertinents. Vos conversations sont privées et sécurisées.
                            </p>
                        </div>
                    </div>
                </div>
