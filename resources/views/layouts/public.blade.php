...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Brillio - La plateforme d\'orientation professionnelle pour les jeunes africains. Découvrez votre personnalité, connectez avec des mentors et construisez votre avenir.')">
    <meta name="keywords" content="orientation, carrière, Afrique, jeunes, mentors, personnalité, MBTI, emploi, formation">
    ...
    <meta property="og:description" content="@yield('og_description', 'La plateforme d\'orientation professionnelle pour les jeunes africains')">
    ...
    <meta property="twitter:description" content="@yield('og_description', 'La plateforme d\'orientation professionnelle pour les jeunes africains')">
        ...
        <nav class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('home') }}" class="font-medium transition-colors" :class="scrolled ? 'text-gray-700 hover:text-primary-600' : 'text-white/90 hover:text-white'">Accueil</a>
                    <a href="{{ route('home') }}#fonctionnalites" class="font-medium transition-colors" :class="scrolled ? 'text-gray-700 hover:text-primary-600' : 'text-white/90 hover:text-white'">Fonctionnalités</a>
                    <a href="{{ route('about') }}" class="font-medium transition-colors" :class="scrolled ? 'text-gray-700 hover:text-primary-600' : 'text-white/90 hover:text-white'">À propos</a>
                ...
                <!-- Mobile menu button -->
                <button @click="mobileMenu = !mobileMenu" class="md:hidden p-2 rounded-lg" :class="scrolled ? 'text-gray-700' : 'text-white'">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="{{ route('home') }}#fonctionnalites" class="text-gray-400 hover:text-white transition-colors">Fonctionnalités</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="{{ route('terms') }}" class="text-gray-400 hover:text-white transition-colors">Conditions d'utilisation</a></li>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <!-- App Store -->
                        <a href="#" class="flex items-center space-x-3 bg-gray-800 rounded-xl p-3 hover:bg-gray-700 transition-colors">
