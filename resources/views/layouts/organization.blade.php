...
<head>
    ...
    $isBranded = $org && $org->isPro(); // covers Pro and Enterprise
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-10 md:flex md:space-x-8">
                        ...
                        <a href="{{ route('organization.advertisements.index') }}"
                            class="{{ request()->routeIs('organization.advertisements.*') ? 'border-organization-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Publicités
                        </a>


                        @if($org && $org->isEstablishment())
                        <a href="{{ route('organization.promotion.index') }}"
                            class="{{ request()->routeIs('organization.promotion.*') ? 'border-organization-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            <i class="fas fa-chart-line mr-2"></i> Promotion
                        </a>
                        @endif
