                ...
                <div class="flex items-center gap-4">
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center gap-2 p-2 rounded-xl hover:bg-gray-100 transition">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-primary-400 to-purple-500 flex items-center justify-center">
                        ...
                        <div x-show="open"
                            ...
                            <a href="{{ route('jeune.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                Mon profil
                            </a>
    ...
    <footer class="bg-white border-t border-gray-100 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                <p class="text-sm text-gray-500">2024 Brillio. Tous droits reserves.</p>
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('privacy') }}" class="text-sm text-gray-500 hover:text-primary-600">Confidentialite</a>
                </div>
            </div>
        </div>
    </footer>
