...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-indigo-500">
            <div class="flex items-center justify-between mb-2">
                <h3 class="text-gray-500 text-sm font-medium uppercase">Revenus Organisations</h3>
                <span class="bg-indigo-100 text-indigo-800 text-xs px-2 py-1 rounded-full"><i
                        class="fas fa-building"></i> Orgs</span>
            </div>
            <p class="text-3xl font-bold text-indigo-600">{{ number_format($orgRevenue, 0, ',', ' ') }} <span
                    class="text-lg text-gray-500">FCFA</span></p>
            <p class="text-xs text-gray-500 mt-2">Abonnements et packs entreprises</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <tr>
                            <td class="py-3">
                                ...
                                <div class="text-xs text-gray-500">
                                    ...
                                    {{ Str::limit($transaction['user']->organization->name, 15) }}
                                    @else
                                    {{ Str::limit($transaction['user']->name ?? 'Utilisateur inconnu', 15) }}
                                    @endif
                                </div>
                            </td>
                            <td class="py-3">
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('admin.accounting.history') }}"
                    class="text-sm text-indigo-600 hover:text-indigo-800">Voir tout l'historique</a>
            </div>
        </div>
    </div>
</div>
