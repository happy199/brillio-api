            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl border border-gray-200 p-6 sticky top-24">
                    ...
                    <form action="{{ route('admin.monetization.settings.update') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Commission Mentorat (%)</label>
                            <div class="relative">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Pourcentage prélevé sur chaque séance payante.</p>
                        </div>
