...
<div class="space-y-6">
    ...
    <div
        ...
        <form action="{{ route('admin.resources.approve_all') }}" method="POST"
            onsubmit="return confirm('Êtes-vous sûr de vouloir valider TOUTES les ressources en attente ?');">
            @csrf
            <button type="submit"
            ...
            <tr class="hover:bg-gray-50">
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        ...
                        @else
                        <div class="h-10 w-10 rounded bg-gray-100 flex items-center justify-center mr-3 text-gray-400">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium uppercase
                        ...
                        @if($resource->type === 'advertisement') Publicité
                        @elseif($resource->type === 'tool') Outils
                        @elseif($resource->type === 'article') Article
