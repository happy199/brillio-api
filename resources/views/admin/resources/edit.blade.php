        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="content" rows="12"
                                class="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3 font-mono transition duration-150 ease-in-out">{{ old('content', $resource->content) }}</textarea>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-4">Types MBTI ciblés (Optionnel)</label>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    ...
                                    <label class="relative group cursor-pointer">
                                        <input type="checkbox" name="mbti_types[]" value="{{ $type }}" 
                                               ...
                                               class="peer sr-only">
                                        <div class="p-3 rounded-lg border border-gray-200 hover:border-{{ $group['color'] }}-500 hover:bg-{{ $group['color'] }}-50 peer-checked:bg-{{ $group['color'] }}-100 peer-checked:border-{{ $group['color'] }}-500 transition-all text-center">
                                            <span class="block font-bold text-gray-700 peer-checked:text-{{ $group['color'] }}-800">{{ $type }}</span>
                                        </div>
                                        <!-- Tooltip -->
                    ...
                    <div x-data="{ 
                        ...
                        <div class="flex flex-wrap items-center gap-2 p-2 border border-gray-200 rounded-lg focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 bg-white">
                            <template x-for="(tag, index) in tags" :key="index">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                                    ...
                                    <button type="button" @click="removeTag(index)" class="ml-1.5 inline-flex items-center justify-center text-indigo-400 hover:text-indigo-600 focus:outline-none">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div x-data="{ isPremium: '{{ old('is_premium', $resource->is_premium) ? '1' : '0' }}' }" class="pt-4 border-t border-gray-100">
                            ...
                            <div class="grid grid-cols-2 gap-3 mb-4">
                                <label class="cursor-pointer">
                                    ...
                                    <div class="p-3 text-center rounded-lg border border-gray-200 bg-white hover:bg-gray-50 peer-checked:bg-green-50 peer-checked:border-green-500 peer-checked:text-green-700 transition">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div class="p-3 text-center rounded-lg border border-gray-200 bg-white hover:bg-gray-50 peer-checked:bg-purple-50 peer-checked:border-purple-500 peer-checked:text-purple-700 transition">
                            ...
                            <div x-show="isPremium === '1'" x-transition class="space-y-2">
                                <label class="block text-sm font-semibold text-gray-700">Prix (FCFA) <span class="text-red-500">*</span></label>
                                <div class="relative">
                                ...
                                <p class="text-xs text-gray-500 text-right">Le prix doit être supérieur à 0 pour premium.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="preview_image_input" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition relative overflow-hidden group">
                                    @if($resource->preview_image_path)
                                        <img src="{{ Storage::url($resource->preview_image_path) }}" alt="Preview" class="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-40 transition">
                                        <div class="relative z-10 flex flex-col items-center justify-center pt-5 pb-6">
                                            <p class="mb-1 text-sm font-semibold text-gray-900 bg-white/80 px-2 rounded">Image actuelle</p>
                                            <p class="text-xs text-gray-700 bg-white/80 px-2 rounded">Cliquez pour changer</p>
                                        </div>
                                    @else
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Fichier joint (PDF, Zip...)</label>
                            <div class="flex items-center justify-center w-full">
                                <label for="file_input" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition">
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        @if($resource->file_path)
                                            <div class="mb-2 text-green-600 bg-green-50 px-3 py-1 rounded-full flex items-center">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                                <span class="text-xs font-bold">Fichier présent</span>
                                            </div>
                                            <p class="text-xs text-gray-500">Cliquez pour remplacer</p>
                                        @else
                                            ...
                                            <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Fichier Ressource</span></p>
                ...
                <div class="flex gap-4">
                    <button type="submit" class="flex-1 bg-indigo-600 text-white font-bold py-3 px-4 rounded-xl hover:bg-indigo-700 transition focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-md hover:shadow-lg transform active:scale-95 duration-150">
                        Mettre à jour
                    </button>
                    <!-- Suppression -->
                    <button type="button" onclick="if(confirm('Êtes-vous sûr de vouloir supprimer cette ressource ?')) document.getElementById('delete-form').submit();" 
                            class="bg-red-100 text-red-700 px-4 py-3 rounded-xl hover:bg-red-200 transition transform active:scale-95 duration-150">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
