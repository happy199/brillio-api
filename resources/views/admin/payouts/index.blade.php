        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @if($payout->is_manual)
                    <div class="mt-1 text-[10px] uppercase font-bold text-orange-600">Traitement Manuel</div>
                    @else
                    <div class="mt-1 text-[10px] uppercase font-bold text-gray-400">Automatique</div>
                    @endif
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
