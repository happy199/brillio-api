...
<div class="max-w-3xl mx-auto" x-data="{ isReportModalOpen: false }">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4 flex items-center gap-4">
        ...
        <a href="{{ route('mentor.mentorship.sessions.create', ['mentee_id' => $mentorship->mentee->id]) }}"
            class="text-xs bg-orange-50 text-orange-600 px-3 py-1.5 rounded-lg font-bold hover:bg-orange-100 transition flex items-center gap-1.5 whitespace-nowrap">
