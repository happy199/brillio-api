    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-5 flex items-start gap-4">
        ...
        <div>
            ...
            <p class="text-yellow-700 text-sm mt-1">
                Votre profil n'est pas encore visible par les jeunes. Publiez-le pour commencer a avoir des statistiques.
            </p>
            <a href="{{ route('mentor.profile') }}" class="inline-block mt-2 text-yellow-800 font-medium underline hover:no-underline">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-3xl font-bold text-gray-900">{{ $profile ? $profile->roadmapSteps()->count() : 0 }}</p>
                    <p class="text-sm text-gray-500">Etapes roadmap</p>
                </div>
            </div>
            <div class="mt-4 pt-4 border-t">
                <a href="{{ route('mentor.roadmap') }}" class="text-xs text-orange-600 hover:underline">Gerer mon parcours</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-3xl font-bold text-gray-900">{{ $profile && $profile->is_validated ? 'Oui' : 'Non' }}</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-3xl font-bold text-gray-900">{{ $profile && $profile->is_published ? 'Publie' : 'Brouillon' }}</p>
                    <p class="text-sm text-gray-500">Statut du profil</p>
                </div>
            </div>
            <div class="mt-4 pt-4 border-t">
                <a href="{{ route('mentor.profile') }}" class="text-xs text-purple-600 hover:underline">Modifier le statut</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        @php
            ...
            $items = [
                ...
                ['label' => 'Domaine d\'expertise', 'done' => !empty($profile?->specialization)],
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Decrivez votre parcours et ce qui vous motive a aider les jeunes.</p>
                </div>
            </div>
            <div class="flex items-start gap-3">
                <div class="w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center flex-shrink-0">
