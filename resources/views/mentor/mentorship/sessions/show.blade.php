            ...
            <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-500">{{ $session->scheduled_at->format('d F Y à H:i') }} •
                        {{ $session->duration_minutes }} min</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <p class="text-gray-500 text-sm mb-6">À remplir pendant ou après la séance pour assurer le suivi.</p>

                    <form action="{{ route('mentor.mentorship.sessions.report', $session) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <!-- 1. Progress -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">1. Avancées du menté depuis la
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-50">
                            ...
                            <span class="font-medium text-gray-900">{{ $session->is_paid ? 'Payante' : 'Gratuite' }}</span>
                        </div>
                        @if($session->is_paid)
                            <div class="flex justify-between py-2 border-b border-gray-50">
