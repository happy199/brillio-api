...
@section('content')
    <div class="space-y-8">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-amber-700 text-sm mt-1">
                            Pour etre visible par les jeunes, completez votre profil (bio, poste, specialisation) et ajoutez au
                            moins une etape a votre parcours.
                        </p>
                        ...
                        <!-- Bouton Publier -->
                        <form action="{{ route('mentor.profile.publish') }}" method="POST" class="mt-4">
                            @csrf
                            <button type="submit"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm card-hover">
                <div
                    class="w-12 h-12 {{ $stats['is_published'] ? 'bg-green-100' : 'bg-gray-100' }} rounded-xl flex items-center justify-center mb-3">
                    <svg class="w-6 h-6 {{ $stats['is_published'] ? 'text-green-600' : 'text-gray-400' }}" fill="none"
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm card-hover">
                <div
                    class="w-12 h-12 {{ $stats['profile_complete'] ? 'bg-green-100' : 'bg-yellow-100' }} rounded-xl flex items-center justify-center mb-3">
                    <svg class="w-6 h-6 {{ $stats['profile_complete'] ? 'text-green-600' : 'text-yellow-600' }}" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <a href="{{ route('mentor.profile') }}" class="bg-white rounded-2xl p-6 shadow-sm card-hover group">
                <div class="flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-500 text-sm mt-1">Modifiez votre bio, poste actuel, entreprise et specialisation
                            pour vous faire connaitre.</p>
            ...
            <a href="{{ route('mentor.roadmap') }}" class="bg-white rounded-2xl p-6 shadow-sm card-hover group">
                <div class="flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                        </svg>
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-500 text-sm mt-1">Racontez votre histoire etape par etape pour inspirer les
                            jeunes qui cherchent leur voie.</p>
            ...
            <button
                ...
                <div class="flex items-start gap-4">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-bold text-gray-900">Importer depuis LinkedIn</h3>
                        <p class="text-gray-500 text-sm mt-1">Remplissez automatiquement votre profil en important votre CV
                            LinkedIn.</p>
                        <div class="mt-3 flex items-center text-blue-600 font-medium text-sm">
                            Importer maintenant
                            <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none"
