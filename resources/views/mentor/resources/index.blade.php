...
<div class="space-y-6">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 text-left flex gap-4">
            ...
            <div>
                ...
                <p class="text-blue-800 text-sm">
                    Vous avez déjà créé des ressources, mais elles sont actuellement <strong>invisibles pour les
                        étudiants</strong> car votre profil n'est pas publié. Republiez votre profil pour les rendre à
                    nouveau accessibles.
                </p>
            </div>
        </div>
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-8 text-left flex gap-4">
            ...
            <div>
                ...
                <p class="text-amber-800">
                    Pour garantir la qualité et la confiance sur la plateforme, <strong>votre profil mentor doit être
                        complété et publié</strong> avant de pouvoir proposer des ressources payantes.
                </p>
            </div>
        </div>

        <a href="{{ route('mentor.profile') }}"
            class="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="{{ route('mentor.resources.create') }}"
            class="w-full sm:w-auto bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition flex items-center justify-center gap-2 shadow-sm hover:shadow-md">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            ...
                            @else
                            <div
                                class="h-12 w-16 rounded bg-gray-100 flex items-center justify-center mr-4 text-gray-400 border border-gray-200">
                            ...
                            <div class="max-w-xs">
                                <div class="text-sm font-bold text-gray-900 truncate" title="{{ $resource->title }}">
                                    {{ $resource->title }}</div>
                                <div class="text-xs text-gray-500 truncate">{{ Str::limit($resource->description, 60) }}
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        ...
                        <span class="font-bold text-gray-900">{{ number_format($resource->price, 0, ',', ' ') }}
                            F</span>
                        <span
                            class="ml-1 text-[10px] text-purple-600 bg-purple-100 px-1 rounded border border-purple-100">PREMIUM</span>
                        @endif
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <a href="{{ route('mentor.resources.create') }}"
                                class="text-indigo-600 font-semibold hover:underline">Créer une ressource</a>
                        </div>
                    </td>
                </tr>
                @endforelse
