...
'INFP' => ['name' => 'Médiateur', 'color' => 'from-green-400 to-cyan-500'],
...
<div class="space-y-8" x-data="personalityTest()">
    ...
    @php
    $typeInfo = $mbtiTypes[$personalityTest->personality_type] ?? ['name' => $personalityTest->personality_label ??
    $personalityTest->personality_type, 'color' => 'from-purple-500 to-pink-500'];
    @endphp
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm">
        <h2 class="text-xl font-bold text-gray-900 mb-6">Tes dimensions de personnalité</h2>
        <div class="space-y-6">
            @php
            $dimensions = [
            ['left' => 'E', 'right' => 'I', 'leftName' => 'Extraversion', 'rightName' => 'Introversion', 'leftColor' =>
            'from-blue-400 to-blue-600', 'rightColor' => 'from-purple-400 to-purple-600'],
            ['left' => 'S', 'right' => 'N', 'leftName' => 'Sensation', 'rightName' => 'Intuition', 'leftColor' =>
            'from-green-400 to-green-600', 'rightColor' => 'from-yellow-400 to-yellow-600'],
            ['left' => 'T', 'right' => 'F', 'leftName' => 'Pensée', 'rightName' => 'Sentiment', 'leftColor' =>
            'from-teal-400 to-teal-600', 'rightColor' => 'from-pink-400 to-pink-600'],
            ['left' => 'J', 'right' => 'P', 'leftName' => 'Jugement', 'rightName' => 'Perception', 'leftColor' =>
            'from-orange-400 to-orange-600', 'rightColor' => 'from-cyan-400 to-cyan-600'],
            ];
            @endphp
    ...
    <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-3xl p-8 text-white text-center">
        ...
        <h1 class="text-3xl font-bold mb-4">Découvre ton type de personnalité</h1>
        <p class="text-white/90 max-w-lg mx-auto">Le test MBTI t'aidera à mieux te connaître et à découvrir les métiers
            qui correspondent à ta personnalité.</p>
    </div>
