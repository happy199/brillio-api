                ...
                <form action="{{ route('mentor.explore') }}" method="GET" class="space-y-4 max-w-full overflow-hidden">
                    ...
                    <div class="max-w-full overflow-hidden">
                        ...
                        <select name="current_situation" class="w-full max-w-full rounded-xl border-gray-200 text-base sm:text-xs focus:border-purple-500 focus:ring-purple-500">
                            ...
                            <option value="emploi" {{ request('current_situation')=='emploi' ? 'selected' : '' }}>En poste</option>
                    ...
                    <div class="max-w-full overflow-hidden">
                        ...
                        <select name="education_level" class="w-full max-w-full rounded-xl border-gray-200 text-base sm:text-xs focus:border-purple-500 focus:ring-purple-500">
                            ...
                            <option value="master" {{ request('education_level')=='master' ? 'selected' : '' }}>Master (Bac+5)</option>
                            <option value="doctorat" {{ request('education_level')=='doctorat' ? 'selected' : '' }}>Doctorat</option>
                        </select>
                    </div>
                    ...
                    <a href="{{ route('mentor.explore') }}" class="block text-center text-xs text-purple-600 hover:underline">
                        Réinitialiser
                    </a>
                    @endif
                </form>
        ...
        <div class="lg:col-span-3">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div
                        class="w-20 h-20 rounded-full flex-shrink-0 overflow-hidden mx-auto mb-4 {{ $jeune->avatar_url ? '' : 'bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center' }}">
                        @if($jeune->avatar_url)
