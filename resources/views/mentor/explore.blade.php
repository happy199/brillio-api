                    ...
                    <div>
                        ...
                        <select name="current_situation"
                            ...
                            <option value="etudiant" {{ request('current_situation')=='etudiant' ? 'selected' : '' }}>
                                Étudiant</option>
                            <option value="recherche_emploi" {{ request('current_situation')=='recherche_emploi'
                                ? 'selected' : '' }}>Recherche d'emploi</option>
                            <option value="emploi" {{ request('current_situation')=='emploi' ? 'selected' : '' }}>En
                                poste</option>
                            <option value="entrepreneur" {{ request('current_situation')=='entrepreneur' ? 'selected'
                                : '' }}>Entrepreneur</option>
                        </select>
                    </div>
