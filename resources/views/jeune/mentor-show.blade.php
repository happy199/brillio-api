...
<div class="space-y-8">
    <!-- Back Button -->
    <a href="{{ route('jeune.mentors') }}" class="inline-flex items-center text-gray-600 hover:text-gray-900 transition">
            ...
            <div class="flex flex-col md:flex-row md:items-start gap-6">
                ...
                <div class="flex-1">
                    <div class="flex items-start justify-between">
                        ...
                        <span class="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-sm flex items-center gap-1">
                    ...
                    <div class="flex flex-wrap gap-2 mt-4">
                        ...
                        <span class="px-3 py-1 bg-white/20 rounded-full text-sm">{{ $mentor->specialization_label }}</span>
                        @endif
                        @if($mentor->years_of_experience)
                        <span class="px-3 py-1 bg-white/20 rounded-full text-sm">{{ $mentor->years_of_experience }} ans d'experience</span>
                        @endif
                ...
                <div class="relative">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="relative pl-16">
                            <!-- Timeline Dot -->
                            <div class="absolute left-4 w-5 h-5 bg-white border-4 border-orange-500 rounded-full transform -translate-x-1/2"></div>
                            ...
                            <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-5">
                                ...
                                <div class="flex flex-wrap gap-2 mt-3">
                                    ...
                                    <span class="px-2 py-1 bg-white text-gray-600 text-xs rounded-full">{{ $skill }}</span>
                                    @endforeach
                                </div>
                                @endif
                            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">{{ $mentor->user->city ? $mentor->user->city . ', ' : '' }}{{ $mentor->user->country }}</p>
                        </div>
                    </div>
                    @endif
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">{{ $mentor->roadmapSteps ? $mentor->roadmapSteps->count() : 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
