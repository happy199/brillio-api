                    ...
                    <div class="flex flex-col md:flex-row gap-8 items-start md:items-center">
                        <div class="relative group mx-auto md:mx-0">
                            <img src="{{ $user->avatar_url }}" alt="{{ $user->name }}"
                                ...
                                class="w-24 h-24 md:w-32 md:h-32 rounded-2xl object-cover bg-gray-100 border-2 border-white shadow-md ring-1 ring-gray-100 transition group-hover:shadow-lg">
                            <button @click="editPersonal = true"
                                class="absolute -bottom-2 -right-2 p-2 bg-white rounded-lg shadow-sm border border-gray-100 text-gray-500 hover:text-blue-600 transition md:hidden group-hover:flex items-center justify-center">
                        ...
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12 w-full">
                            <div>
                        ...
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_public" value="1" class="sr-only peer" {{
                                    $profile->is_public ? 'checked' : '' }} onchange="this.form.submit()">
                                <div
