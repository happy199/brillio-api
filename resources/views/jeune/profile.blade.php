...
<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-primary-500 via-purple-500 to-pink-500 rounded-3xl p-8 text-white">
        <div class="flex flex-col md:flex-row md:items-center gap-6">
            <div class="relative">
                <div class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center overflow-hidden">
                    @if($user->avatar_url)
                ...
                <button class="absolute -bottom-2 -right-2 w-8 h-8 bg-white text-primary-600 rounded-full flex items-center justify-center shadow-lg hover:bg-gray-100 transition">
            ...
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-2 mt-3">
                    ...
                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm">{{ $user->personalityTest->personality_type }}</span>
                    @endif
                    <span class="px-3 py-1 bg-white/20 rounded-full text-sm">Membre depuis {{ $user->created_at->format('M Y') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $user->birth_date ? $user->birth_date->format('d/m/Y') : 'Non renseigne' }}</p>
                    </div>
                    <div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-3 py-1 bg-primary-100 text-primary-700 text-sm rounded-full">{{ $interest }}</span>
                            @endforeach
                        </div>
                    </div>
                    @endif
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-gray-900">{{ $user->personalityTest->personality_label ?? $user->personalityTest->personality_type }}</p>
                        <p class="text-sm text-gray-500">Passe le {{ $user->personalityTest->completed_at->format('d/m/Y') }}</p>
                    </div>
                ...
                <div class="text-center py-6">
                    ...
                    <a href="{{ route('jeune.personality') }}" class="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:shadow-lg transition">
                        Passer le test MBTI
                    </a>
                </div>
                @endif
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-bold text-gray-900">{{ $user->chatConversations()->withCount('messages')->get()->sum('messages_count') }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                ...
                <div class="space-y-3">
                    ...
                    <a href="#" class="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700">Confidentialite</span>
                        </div>
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-red-100">
                ...
                <p class="text-sm text-gray-600 mb-4">Une fois supprime, ton compte et toutes tes donnees seront definitivement perdus.</p>
                <button class="w-full py-2 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition font-medium">
    ...
    <div class="bg-white rounded-3xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b sticky top-0 bg-white rounded-t-3xl">
            <div class="flex items-center justify-between">
                ...
                <button onclick="document.getElementById('editProfileModal').classList.add('hidden')" class="p-2 hover:bg-gray-100 rounded-full">
