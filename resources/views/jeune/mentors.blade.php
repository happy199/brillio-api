...
<div class="space-y-8">
        ...
        <div x-show="showFilters" x-collapse class="mt-4 pt-4 border-t">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    ...
                    <select id="filterSpecialization" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <select id="filterCountry" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <select id="filterExperience" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                ...
                <div class="flex items-end">
                    <button onclick="applyFilters()" class="w-full px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition">
                        Appliquer
                    </button>
                </div>
            </div>
        ...
        <a href="{{ route('jeune.mentors.show', $mentor) }}" class="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
            ...
            <div class="px-5 pb-5 -mt-10">
                ...
                <div class="mt-4 pt-4 border-t flex items-center justify-between">
                    ...
                    <span class="text-primary-600 font-medium text-sm flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                        Voir le parcours
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-2xl p-12 text-center">
        ...
        <a href="{{ route('jeune.mentors') }}" class="px-6 py-3 bg-primary-500 text-white font-semibold rounded-xl hover:bg-primary-600 transition">
