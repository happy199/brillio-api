...
<div x-data="{ 
    ...
    <div class="space-y-8">
        ...
        <div x-show="activeTab === 'active'" x-transition.opacity>
            ...
            <div class="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-100">
                ...
                <a href="{{ route('jeune.mentors') }}" class="text-indigo-600 font-medium hover:text-indigo-800">Trouver
                    un mentor &rarr;</a>
            </div>
            @else
                ...
                <div
                    ...
                    <div class="mt-auto pt-6 border-t border-gray-100 flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('jeune.messages.show', $mentorship) }}"
                            class="flex-1 text-center px-4 py-2 bg-indigo-100 text-indigo-700 text-sm font-medium rounded-lg hover:bg-indigo-200 transition whitespace-nowrap">
                            Messages
                        </a>
                        <button
        ...
        <div x-show="activeTab === 'pending'" x-cloak>
            ...
            <div class="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-100">
                ...
                <p class="text-gray-500 mb-6 max-w-md mx-auto">Toutes vos demandes ont été traitées ou vous n'en avez
                    pas encore envoyé.</p>
                <a href="{{ route('jeune.mentors') }}"
                    class="text-indigo-600 font-medium hover:text-indigo-800">Chercher un mentor &rarr;</a>
            </div>
            @else
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800">Annulé</span>
                                @else
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800">Terminé</span>
                                @endif
                            </td>
    ...
    <!-- Cancel Modal -->
    <div x-show="showCancelModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" x-cloak
        x-transition>
        <div class="bg-white rounded-3xl max-w-md w-full p-6" @click.away="showCancelModal = false">
            ...
            <form :action="cancelUrl" method="POST">
                @csrf
                <div class="mb-5">
                    <label for="cancellation_reason" class="block text-sm font-medium text-gray-700 mb-1">Raison
                        (obligatoire)</label>
